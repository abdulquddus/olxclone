    ...
    public function teszt($amount,$description)
    {
        $apiContext = new \PayPal\Rest\ApiContext(
            new \PayPal\Auth\OAuthTokenCredential(
                'ATTPZ6Ef8NOFfjVk9gFbfXGl2KBy3HCm5FJbrLBcd-izKrg0iJkgS_HUcWRGYPJLxHkeiXxjOGVLopFo',     // ClientID
                'EPeQ2daNIKo-a5DTwZd0YzDzAASHx_ye9vlczKscJLOCv3p38Srzs8sn9bj_cRwS4swnAqrD8y_vqBik'      // ClientSecret
            )
        );
