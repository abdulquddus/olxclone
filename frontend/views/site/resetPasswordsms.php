      ...
      <div class="container">
        ...
        'horizontalCssClasses' => [
            ...
            'hint' => '',
                ...
                <?= $form->field($model, 'password_hash', ['template'=>' <div class="input-group custom-field-wrap">
                        <label for="userEmail">Password</label>
                        {input}
                     </div> <span style="text-align: center; margin-top: -2px;">{error}</span> ', ])->passwordInput()->label("Please choose your new password:") ?>
                    <?= $form->field($model, 'password_repeat', ['template'=>' <div class="input-group custom-field-wrap">
