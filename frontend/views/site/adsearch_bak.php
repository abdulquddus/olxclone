         ...
         <div class="row">
           <div class="listing-box">
               <div class="col-md-3 mr-iob-blr">
                 <div style="background: url('https://content.makaan.com/16/6109519/274/6863152.jpeg?width=360&height=270') 0 0 no-repeat; height:30vh; background-size:cover; background-position:center; border:#ccc 1px solid"></div>
				 </div>
               <div class="col-md-9">
                  <h4><a href="#">4 BHK Apartment</a> </h4>
                  <ul class="poperty-details-iob">
                     ...
                     <li>
                     <a href="#"View Detail>View More</a>
                     </li>
