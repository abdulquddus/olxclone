				...
				<div class="col-lg-8 adview-content">
						<div class="offercontent">
								<div class="offerheadinner">
										<h1><?= $model->advertise_title;?></h1>
										<p>
												<span class="offerheadleft">
														<span class="markerloc"></span>
													<span class="offerheadtxt"><?= $model->state_id ?>, <?=  $model->city_id; ?></span>
												</span>
												<span class="offerheadright">
														<span>Added at <?= Yii::$app->formatter->asDatetime($model->created_date)?>, <span>Ad ID: <span><?= $model->id ?></span></span>
														</span>
												</span>
										</p>
								</div>
...
<div class="col-xs-12">
    ...
    $k=0;
     foreach($model->imageFiles as $img){?>
...
<!--									<div class="addescriptiontoptxt">
									...
									<div class="adview">
											Views:<strong><?= $model->description; ?></strong>
									</div>
								</div>
						</div>
				</div><!--/.adview-content-->
						...
						<div class="userdatabox">
						   <div class="userbox">
						      ...
						      <div class="userdetails">
						         <div class="ad-user-name"><?= $model->contact_name ?></div>
