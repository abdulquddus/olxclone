    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?= Url::toRoute(['/user/setting', 'hash'=>'message'])?>">Messages</a></li>
            <li><a href="#">Favourites</a></li>
            <li><a href="#">Ads</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="<?= Url::toRoute(['/user/setting', 'hash'=>'setting'])?>">Account Settings</a></li>
            <li><a href="<?= Url::toRoute(['/user/setting', 'hash'=>'setting'])?>">Profile</a></li>
...
//          alert(text3);
          $('.sb').hide();
          $('#'+sel2).fadeIn(100);
          $('#cate').html('<label>Category<b class="asterisk">*</b></label><h5> <i class="fa fa-car"></i> '+text+' >> '+text2+'</h5><a data-target="#category" data-toggle="modal" class="btn btn-primary tog"  href="#">change</a>');
//          $('#category').modal('toggle');
            $(".hiddene").hide();
            $("#"+catid).show();
            $("#advertisement-category_id").val(catid);
